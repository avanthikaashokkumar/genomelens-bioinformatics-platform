def build(stats: dict, orfs: list[dict], complexity: dict) -> list[str]:
    ...
    notes += ["The melting temperature is an approximation under assumed conditions, not a laboratory protocol.", "Results are educational and must not be used for medical diagnosis."]
    return notes
