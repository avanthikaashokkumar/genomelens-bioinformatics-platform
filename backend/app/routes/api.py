...
from ..services.sequence_cleaner import clean_sequence, clean_motif, SequenceValidationError
...
def analyze(request: AnalyzeRequest):
    ...
    orfs = orf_finder.find_orfs(sequence, request.minimum_orf_length)
